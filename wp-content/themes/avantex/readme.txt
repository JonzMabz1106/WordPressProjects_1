...
Jost - Google Font Family - open source
Source: https://fonts.googleapis.com/css2?family=Jost
Licensed : licensed under Creative Commons: CC BY-SA 4.0
...
Licensed: https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License)

Swiper 5.4.5 http://swiperjs.com
Copyright 2014-2020 Vladimir Kharlampidi
Licensed: Released under the MIT License
...
BxSlider v4.1.2
Source: http://bxslider.com Written by: Steven Wanderski, 2014
Licence: Released under the MIT license - http://opensource.org/licenses/MIT
...
Source_1: https://images.pexels.com/photos/3184306/pexels-photo-3184306.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1
Source_2: https://pxhere.com/en/photo/1445813


=== Changelog == 

Version 0.2.6
	* example@corpo fixed to example@example fixed
Version 0.2.5
	* Child theme edu issue fixed
Version 0.2.4
	* Child theme issue fixed
Version 0.2.3
	* Tested upto 6.3.1
Version 0.2.2
	* Automobile load fixes. 
Version 0.2.1
	* Fixed Header Already Send.
Version 0.2.0
	* Fixed Css menu conflict for menu break at larger size.
Version 0.1.9
	* Construction load fixes.
Version 0.1.8
	* Callout button invalid value fixed.
Version 0.1.7
	* Demo import services image control issue fixed.
Version 0.1.6
	* Search tab focus fixed.
	* Performance fix desc.
Version 0.1.5
	* Topbar fixed.
	* Extra Contents added.
	* Preview description fixed.
	* Demo data page load fixed.
Version 0.1.4
	* Theme Review Links decoration Fixed.
	* Header demo data fix.
Version 0.1.3
	* Slider response fix.
Version 0.1.2
	* Fixed Slider btn link.
Version 0.1.1
	* Finalized theme to initial version
